...
def add_billboard_to_spotify(input_songs, input_user_year):
    ...
    spotipy_search.spotify_generate_uri_list(input_songs, input_user_year)
...
songs, user_year = get_billboard_top_100_data()
add_billboard_to_spotify(songs, user_year)
